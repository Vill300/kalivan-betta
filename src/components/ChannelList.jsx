...
export default function ChannelList({channels, active, onSelect, onDelete, onFriendsClick}){
  const { t } = useLang()
  ...
  return (
    <aside className="channel-list" ref={containerRef}>
      <div className="channel-top">
        <div className="top-item" onClick={onFriendsClick}><svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10zM2 22c0-3.3 3.6-6 10-6s10 2.7 10 6" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg> <span>{t('friends')}</span></div>

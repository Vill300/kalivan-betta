    ...
    <>
      ...
      <div className="left-bottom-panel" role="region" aria-label="User controls">
        ...
        <div className="lb-actions">
          ...
          <button className="lb-btn" title="Settings" onClick={()=>setShowSettings(true)}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 15.5A3.5 3.5 0 1 0 12 8.5a3.5 3.5 0 0 0 0 7z" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round"/></svg>
          </button>
        </div>
